...
<div style="display: inline-block;">
  <img src="/movielens/graphs/cum_density.png" alt="Cumulative Density of Rating Counts" title="Cumulative Density of Rating Counts" style="float: left; margin-right: 10px; width: 45%;">
  <img src="/movielens/graphs/box-whisker-decile.png" alt="Box-and-Whisker Plot of Rating Counts by Decile" title="Box-and-Whisker Plot of Rating Counts by Decile" style="float: left; margin-right: 10px; width: 45%;">
</div>
